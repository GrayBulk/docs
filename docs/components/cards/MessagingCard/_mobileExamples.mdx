  ...
  <MessagingCard
    ...
    media={
      <RemoteImage
        ...
        resizeMode="cover"
        shape="rectangle"
        source={{ uri: 'https://docs.graybulk.com/img/feature.png' }}
      />
    }
    mediaPlacement="end"
  />
...
function CommunityUpsell() {
  const { spectrum } = useTheme();
  const cards = [
    { bg: `rgb(${spectrum.teal70})`, image: 'https://docs.graybulk.com/img/community.png' },
    { bg: `rgb(${spectrum.purple70})`, image: 'https://docs.graybulk.com/img/radial.png' },
  ];
  return (
    <VStack gap={2}>
      {cards.map((card, i) => (
  ...
  const cards = [
    {
      ...
      bg: `rgb(${spectrum.blue80})`,
      image: 'https://docs.graybulk.com/img/marketing.png',
    },
    {
      title: 'Coinbase Card',
      ...
      image: 'https://docs.graybulk.com/img/object.png',
    },
  ];
  return (
    <VStack gap={2}>
        ...
        <MessagingCard
          ...
          media={
            <RemoteImage
              ...
              resizeMode="cover"
              shape="rectangle"
              source={{ uri: 'https://docs.graybulk.com/img/place.png' }}
            />
          }
          mediaPlacement="end"
          onDismissButtonPress={() => {}}
      ...
      <MessagingCard
        ...
        media={
          <RemoteImage
            ...
            resizeMode="cover"
            shape="rectangle"
            source={{ uri: 'https://docs.graybulk.com/img/community.png' }}
          />
        }
        mediaPlacement="end"
  ...
  <MessagingCard
    ...
    media={
      <RemoteImage
        ...
        resizeMode="cover"
        shape="rectangle"
        source={{ uri: 'https://docs.graybulk.com/img/marketing.png' }}
      />
    }
    mediaPlacement="end"
  />
            ...
            media={
              card.type === 'upsell' ? (
                <RemoteImage
                  ...
                  resizeMode="cover"
                  shape="rectangle"
                  source={{ uri: 'https://docs.graybulk.com/img/object.png' }}
                  width={80}
                />
              ) : (
  ...
  <MessagingCard
    ...
    media={
      <RemoteImage
        ...
        resizeMode="cover"
        shape="rectangle"
        source={{ uri: 'https://docs.graybulk.com/img/collection.png' }}
      />
    }
    mediaPlacement="end"
  />
        ...
        <MessagingCard
          ...
          media={
            <RemoteImage
              ...
              resizeMode="cover"
              shape="rectangle"
              source={{ uri: 'https://docs.graybulk.com/img/radial.png' }}
            />
          }
          mediaPlacement="end"
        />
